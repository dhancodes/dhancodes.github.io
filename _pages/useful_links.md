...
- I use [fedora](https://fedoraproject.org/), a user-friendly and widely
  supported Linux distribution.
- I love using [Vim](https://www.vim.org/) to create and modify text documents.
- For typesetting I prefer [markdown](https://www.markdownguide.org/) and when
  more mathematical equations are involved I turn to [LaTeX](https://www.latex-project.org/).
